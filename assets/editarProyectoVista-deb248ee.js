import { P as Proyectos } from "./proyectos-6ae50737.js";
import "./main-4875579e.js";
const editarProyectoVista = {
  ...
  script: async (id = -1) => {
    ...
    descripcionProyecto.value = await proyecto.description;
    ...
    formProyecto.addEventListener("submit", async function(e) {
      ...
      proyecto.description = descripcionProyecto.value;
