...
class Perfil {
  ...
  static async getById(id) {
    const { data: perfiles, error } = await supabase.from("Perfiles").select("*").eq("id", id).single();
    if (error) {
      throw new Error(error.message);
    }
  ...
  static async getByUserId(id) {
    const { data: perfiles, error } = await supabase.from("Perfiles").select("*").eq("user_id", id).single();
    if (error) {
      throw new Error(error.message);
    }
    return new Perfil(perfiles.id, perfiles.createdAt, perfiles.nombre, perfiles.user_id, perfiles.estado, perfiles.rol, perfiles.avatar, perfiles.apellidos, perfiles.email);
...
const formEditarPerfil = {
  ...
  <div class="modal-dialog" role="document">
    ...
    `,
  script: async () => {
    document.querySelector("#formEditarUsuario");
...
const enrutador = {
  ...
  rutas: {
    home: __vitePreload(() => import("./homeVista-4f8d4e9c.js"), true ? [] : void 0, import.meta.url),
    // Usuarios
    adminUsuarios: __vitePreload(() => import("./adminVista-bbf3953d.js"), true ? [] : void 0, import.meta.url),
    registro: __vitePreload(() => import("./registroVista-8dcc8a0d.js"), true ? [] : void 0, import.meta.url),
    login: __vitePreload(() => import("./loginVista-0fa0d64d.js"), true ? [] : void 0, import.meta.url),
    // Proyectos
    proyectos: __vitePreload(() => import("./proyectosVista-c12b24b3.js"), true ? ["./proyectosVista-c12b24b3.js","./proyectos-9ff6e2ab.js"] : void 0, import.meta.url),
    nuevoProyecto: __vitePreload(() => import("./nuevoProyectoVista-619f1eb4.js"), true ? ["./nuevoProyectoVista-619f1eb4.js","./proyectos-9ff6e2ab.js"] : void 0, import.meta.url),
    editarProyecto: __vitePreload(() => import("./editarProyectoVista-1589f78a.js"), true ? ["./editarProyectoVista-1589f78a.js","./proyectos-9ff6e2ab.js"] : void 0, import.meta.url),
    detalleProyecto: __vitePreload(() => import("./detalleProyectoVista-5458d0b6.js"), true ? ["./detalleProyectoVista-5458d0b6.js","./proyectos-9ff6e2ab.js"] : void 0, import.meta.url)
